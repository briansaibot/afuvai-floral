...
export const BULK_FLOWERS = [
  {
    id: 1,
    name: "Petite Ivory Box",
    price: 165,
    marketPrice: false,
    img: WHITE_FLORAL,
    desc: "50 SA roses + greenery — entry tier",
    contents: ["50 South African roses", "Mixed eucalyptus & greenery", "Includes care guide"],
  },
  {
    id: 2,
    name: "Ivory Rose Bulk Box",
    price: 425,
    marketPrice: false,
    img: ROSE_IMG,
    desc: "125 SA roses (60cm) + eucalyptus + ruscus — bread-and-butter DIY-bride SKU",
    contents: ["125 South African roses (60cm stems)", "Fresh eucalyptus & ruscus", "Premium care guide & conditioning"],
  },
  {
    id: 3,
    name: "Garden Romance Bulk Bundle",
    price: 525,
    marketPrice: false,
    img: PINK_BOUQUET,
    desc: "Roses + white designer hydrangea + greenery mix",
    contents: ["Garden roses (premium mix)", "White designer hydrangea", "Seasonal greenery mix", "Florist conditioning supplies"],
  },
  {
    id: 4,
    name: "Tropical Vegas Luxe Bundle",
    price: 299,
    marketPrice: false,
    img: RECEPTION_TABLE,
    desc: "Anthurium, bird of paradise, dendrobium orchid, ti leaf — AFUVAI differentiator, ties to Polynesian identity",
    contents: ["Premium anthurium stems", "Exotic bird of paradise", "Dendrobium orchids", "Dramatic ti leaf accents"],
  },
  {
    id: 5,
    name: "Grand Event Bulk Package",
    price: 1350,
    marketPrice: false,
    img: WEDDING_ARCH,
    desc: "250 premium roses, garden roses, magnolia, curly willow — big weddings/corporate",
    contents: ["250 premium assorted roses", "Garden roses (premium selection)", "Magnolia branches", "Curly willow & structural greenery", "Full conditioning kit"],
  },
  {
    id: 6,
    name: "Greenery & Filler Pack",
    price: 95,
    marketPrice: false,
    img: GARDEN_MIX,
    desc: "Upsell alongside any tier",
    contents: ["Assorted eucalyptus varieties", "Salal & ruscus", "Seasonal green branches", "Filler flowers (baby's breath, waxflower)"],
  },
  // Market Price Items (Dahlias, Peonies, Protea, Flowering Branches)
  {
    id: 7,
    name: "Dahlias (Market Price)",
    price: null,
    marketPrice: true,
    startingAt: 250,
    img: PINK_BOUQUET,
    desc: "Premium dahlias in seasonal colors — pricing varies",
    contents: ["25–50 stems depending on variety", "Seasonal color mix", "Care guide included"],
  },
  {
    id: 8,
    name: "Peonies (Market Price)",
    price: null,
    marketPrice: true,
    startingAt: 300,
    img: PURPLE_BOUQUET,
    desc: "Premium peonies (seasonal availability) — pricing varies",
    contents: ["20–40 stems depending on season", "Premium grade A blooms", "Florist conditioning"],
  },
  {
    id: 9,
    name: "Flowering Branches (Market Price)",
    price: null,
    marketPrice: true,
    startingAt: 200,
    img: GARDEN_MIX,
    desc: "Seasonal flowering branches (cherry, apple, flowering almond) — pricing varies",
    contents: ["Architectural branches (3–5 stems)", "Seasonal variety", "Perfect for weddings & events"],
  },
  {
    id: 10,
    name: "Protea Mix (Market Price)",
    price: null,
    marketPrice: true,
    startingAt: 350,
    img: RECEPTION_TABLE,
    desc: "Premium protea and exotic flowers — pricing varies",
    contents: ["Premium protea stems", "Exotic botanicals", "Best for statement arrangements"],
  },
];
